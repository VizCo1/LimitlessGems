[System.Serializable]
public sealed class SpecialZoneLayerZSerializer : ZSerializer.Internal.ZSerializer
{
    ...
    public SpecialZoneLayerZSerializer(string ZUID, string GOZUID) : base(ZUID, GOZUID)
