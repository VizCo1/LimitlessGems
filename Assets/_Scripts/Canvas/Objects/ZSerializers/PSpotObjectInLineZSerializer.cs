[System.Serializable]
public sealed class PSpotObjectInLineZSerializer : ZSerializer.Internal.ZSerializer
{
    ...
    public PSpotObjectInLineZSerializer(string ZUID, string GOZUID) : base(ZUID, GOZUID)
