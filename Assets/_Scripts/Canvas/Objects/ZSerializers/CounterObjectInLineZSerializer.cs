[System.Serializable]
public sealed class CounterObjectInLineZSerializer : ZSerializer.Internal.ZSerializer
{
    ...
    public CounterObjectInLineZSerializer(string ZUID, string GOZUID) : base(ZUID, GOZUID)
    {       var instance = ZSerializer.ZSerialize.idMap[ZSerializer.ZSerialize.CurrentGroupID][ZUID];
         ...
         keyLevel = (System.Int32)typeof(CounterObjectInLine).GetField("keyLevel", System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic).GetValue(instance);
    ...
    public override void RestoreValues(UnityEngine.Component component)
    {
         ...
         typeof(CounterObjectInLine).GetField("keyLevel", System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic).SetValue(component, keyLevel);
